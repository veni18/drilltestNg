package TestRunner;
	...
	public class WriteExcel {
	    ...
	    public static void main(String...strings) throws IOException{
	        ...
	        String[] valueToWrite = {"Edward","Street1"};

	        //Create an object of current class

	        WriteExcel objExcelFile = new WriteExcel();
	        String fileFolder = new File("dataresults/").getAbsolutePath();
	        objExcelFile.writeExcel(fileFolder,"TestResults2.xlsx","sheet1",valueToWrite);
